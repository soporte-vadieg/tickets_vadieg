...
const API_URL = 'http://192.168.1.44:5000/api/tickets';
...
export const createTicket = async (ticketData) => {
    try {
        ...
        const response = await axios.post('http://192.168.1.44:5000/api/tickets-create', ticketData, {
            headers: {
...
export const getAreas = async () => {
    try {
        const response = await axios.get('http://192.168.1.44:5000/api/areas', { headers: getAuthHeaders() });
        return response.data;
    } catch (error) {
...
export const getCate = async () => {
    try {
        const response = await axios.get('http://192.168.1.44:5000/api/categorias', { headers: getAuthHeaders() });
        return response.data;
    } catch (error) {
